    ...
    <Wrapper>
      ...
      <InWrapper>
        <Line1>
          ...
          <FlowerDetail
            name={seasonData0.flower}
            period={seasonData0.period}
            flower_lang={seasonData0.flower_language}
            height="100%"
            width="100%"
          ></FlowerDetail>
        </Line1>
        <Line2>
          <Image23>
            ...
            <FlowerDetail
              name={seasonData1.flower}
              period={seasonData1.period}
              flower_lang={seasonData1.flower_language}
              height="50%"
              width="100%"
            ></FlowerDetail>
          </Image23>
          <Image23>
            ...
            <FlowerDetail
              name={seasonData2.flower}
              period={seasonData2.period}
              flower_lang={seasonData2.flower_language}
              height="50%"
              width="100%"
            ></FlowerDetail>
          </Image23>
        ...
        <Line3>
          <Image4>
            ...
            <FlowerDetail
              name={seasonData3.flower}
              period={seasonData3.period}
              flower_lang={seasonData3.flower_language}
              height="67%"
              width="100%"
            ></FlowerDetail>
          </Image4>
          <Image5>
            ...
            <FlowerDetail
              name={seasonData4.flower}
              period={seasonData4.period}
              flower_lang={seasonData4.flower_language}
              height="33%"
              width="100%"
            ></FlowerDetail>
          </Image5>
